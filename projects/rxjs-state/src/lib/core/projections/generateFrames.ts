...
export function generateFrames(
  ...
  return asyncProducer || asyncCanceler ? generateFramesFactory(
    asyncProducer,
    asyncCanceler,
    timestampProvider
 ...
 */
const DEFAULT_GENERATE_FRAMES_OPERATOR = generateFramesFactory(window.requestAnimationFrame, window.cancelAnimationFrame);
